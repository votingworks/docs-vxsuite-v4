...
**A.9** is covered by [Diagnostics VxAdmin](../user-manual/vxadmin-system-setup/diagnostics-vxadmin.md), [VxScan System Administrator Functions & System Diagnostics](../user-manual/vxscan/system-administrator-functions-and-system-diagnostics.md#system-diagnostics), [Diagnostics VxCS](../user-manual/vxcentralscan/diagnostics-vxcs.md), and [VxMark System Administrator Functions & System Diagnostics.](../vxmark/system-administrator-functions-and-system-diagnostics.md#system-diagnostics)&#x20;
{% endhint %}
...
{% hint style="success" %}
Requirement **3.1.5-G** is covered by [Operations Environment](../user-manual/reference/operations-environment.md).
{% endhint %}
...
{% hint style="success" %}
Requirement **3.1.5-I.4** is covered by [Diagnostics VxAdmin](../user-manual/vxadmin-system-setup/diagnostics-vxadmin.md), [VxScan System Administrator Functions & System Diagnostics](../user-manual/vxscan/system-administrator-functions-and-system-diagnostics.md#system-diagnostics), [Diagnostics VxCS](../user-manual/vxcentralscan/diagnostics-vxcs.md), and [VxMark System Administrator Functions & System Diagnostics.](../vxmark/system-administrator-functions-and-system-diagnostics.md#system-diagnostics)&#x20;
{% endhint %}

{% hint style="success" %}
Requirement **3.1.5-J.1** is covered by [VotingWorks](../user-manual/) overview.
{% endhint %}
...
{% hint style="success" %}
Requirement **3.1.5.K.1** is covered by [Equipment Inspection & Transportation.](../user-manual/logic-and-accuracy-pre-election-testing/equipment-inspection-and-transportation.md)
{% endhint %}
...
{% hint style="success" %}
Requirements **3.2-B.1, 3.2-D**, **3.2-E,** and **3.2-K** are covered by [Equipment Inspection & Transportation](../user-manual/logic-and-accuracy-pre-election-testing/equipment-inspection-and-transportation.md).
{% endhint %}

{% hint style="success" %}
Requirement **3.2-O** is covered by [Diagnostics VxAdmin](../user-manual/vxadmin-system-setup/diagnostics-vxadmin.md) and VxScan [System Administrator Functions & System Diagnostics](../user-manual/vxscan/system-administrator-functions-and-system-diagnostics.md).&#x20;
{% endhint %}

{% hint style="success" %}
All **3.2-Q** requirements are covered by [Equipment Inspection & Transportation](../user-manual/logic-and-accuracy-pre-election-testing/equipment-inspection-and-transportation.md).
{% endhint %}
